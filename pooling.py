...
path = "C:\\Anju\\Final Year Project\\Stanford drone dataset\\newannotations\\train\\frame\\" + scene + "0train\\" + scene + "0train_"
...
for E in xrange(EPOCHS):
    inputpath = "C:\\Anju\\Final Year Project\\Stanford drone dataset\\newannotations\\train\\classes\\" + scene + "0entities\\" + scene + "0train"
        ...
        for e in xrange(len(tempEN) - 1):
            for n in xrange(e + 1, len(tempEN)):
                ...
                if (int(tempEN[e][5]) + 100 >= int(tempEN[n][5])) and (
                                int(tempEN[e][5]) - 100 <= int(tempEN[n][5])) and (
                                int(tempEN[e][6]) + 100 >= int(tempEN[n][6])) and (
                                int(tempEN[e][6]) - 100 <= int(tempEN[n][6])):
